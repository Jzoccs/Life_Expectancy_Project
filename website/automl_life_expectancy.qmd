...
import sys, os
sys.path.append(os.path.abspath(".."))          # parent folder
sys.path.append(os.path.abspath("."))           # current project root
sys.path.append(os.path.abspath("../src"))      # direct path to src
